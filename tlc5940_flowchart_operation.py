...
class TLC5940_chip:
    ...
    def GrayScale_cycle(self, gs_string):
        ...
        print('Cycle took = ', utime.time_ns() - start, ' ns')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        gs_byte_string = '000000000000'*1 + '111111111111'*1 + '000000000000'*14
        ...
        gs_byte_string = '000000000000'*3 + '111111111111'*1 + '000000000000'*12
        ...
        gs_byte_string = '000000000000'*5 + '111111111111'*1 + '000000000000'*10
        ...
        gs_byte_string = '000000000000'*7 + '111111111111'*1 + '000000000000'*8
        ...
        gs_byte_string = '000000000000'*9 + '111111111111'*1 + '000000000000'*6
        ...
        gs_byte_string = '000000000000'*11 + '111111111111'*1 + '000000000000'*4
        ...
        gs_byte_string = '000000000000'*13 + '111111111111'*1 + '000000000000'*2
        ...
        gs_byte_string = '000000000000'*15 + '111111111111'*1
